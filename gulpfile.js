...
const PROJECT_NAME = 'Betex';                                                   // Указываем название нашего проекта
 ...
 * jade
 ********************************************************************************/
gulp.task('jade', () => {                                                       // Компилируем jade в html
    return gulp.src(paths.src.jade)                                             // Выберем файлы по нужному пути
        .pipe(jade({ pretty: true})).on('error', notify.onError())              // Найтройки jade
